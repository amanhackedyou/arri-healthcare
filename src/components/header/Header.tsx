...
const Header = () => {
  ...
  return (
    <div className="w-full flex flex-col">
      ...
      <div className="flex flex-col relative overflow-hidden md:flex-row items-center md:items-start bg-[#eae9e9] md:bg-transparent px-4 gap-2 md:gap-6 mb-2- py-2">
        <div className="w-full md:hidden absolute top-0 shadow-[0px_0px_10px_3px_rgba(0,0,0,0.13)] bg-[#000]- h-[1px]"></div>
