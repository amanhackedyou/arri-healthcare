...
const ServicesWeOffer = () => {
    return (
        <section className='px-6 bg-transparent font-rubik pt-4 flex flex-col py-2 items-center gap-2'>
            ...
            <ServiceCard title='Out-of-home Services' dotColor='#fe8f01' services={[
                {
            ...
            <ServiceCard title='In-home-services' dotColor='#096982' services={[
                {
                    title: "Companionship",
...
const ServiceCard: React.FC<ServiceCardProps> = ({ title, services, dotColor }) => {
