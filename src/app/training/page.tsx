        ...
        <>
            ...
            <div className='flex flex-col gap-4 p-4'>
                <div className='flex flex-col gap-3 items-center'>
                    <a href='https://mylearning.dodd.ohio.gov/' target='_blank' className='text-2xl w-full mb-2 text-primaryBlue'>Direct Support Professional (DSP) Initial Training</a>
                    ...
                    <a href='https://mylearning.dodd.ohio.gov/' target='_blank' className='px-4 py-2 bg-primaryYellow rounded-full font-medium text-white'>Go to Training</a>
                </div>
            </div>
        </>
    )
